...
const photography = [{href:"/admin/photography/galleries",label:"Galleries",glyph:"▦"},{href:"/admin/photography/uploads",label:"Uploads",glyph:"⇧"},{href:"/admin/collections",label:"Collections",glyph:"◫"}];
const studio = [{href:"/admin/content",label:"Content",glyph:"✦"},{href:"/admin/media",label:"Media library",glyph:"▧"},{href:"/admin/analytics",label:"Analytics",glyph:"⌁"},{href:"/admin/search",label:"Search",glyph:"⌕"},{href:"/admin/settings",label:"Settings",glyph:"⚙"}];
const mobile = [main[0], photography[0], photography[1], studio[3]];
